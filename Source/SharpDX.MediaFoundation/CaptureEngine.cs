...
namespace SharpDX.MediaFoundation
{
    ...
    public partial class CaptureEngine
    {
        ...
        {
            Initialize_(CaptureEngineOnEventCallbackShadow.ToIntPtr(captureEngineOnEventImpl), attributesRef, audioSourceRef.NativePointer, videoSourceRef.NativePointer);
        }
