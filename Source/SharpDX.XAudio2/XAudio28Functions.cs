...
namespace SharpDX.XAudio2
{
    ...
    static  partial class XAudio28Functions {   
        ...
        /// if ( FAILED(hr = <see cref="SharpDX.XAudio2.XAudio2Functions.XAudio2Create"/>( &amp;pXAudio2, 0, <see cref="SharpDX.XAudio2.ProcessorSpecifier.DefaultProcessor"/> ) ) ) return hr;	
        /// ...	
        ...
        [DllImport("xaudio2_8.dll", EntryPoint = "CreateAudioReverb", CallingConvention = CallingConvention.StdCall)]
        ...
        [DllImport("xaudio2_8.dll", EntryPoint = "CreateAudioVolumeMeter", CallingConvention = CallingConvention.StdCall)]
