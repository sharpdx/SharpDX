...
bin/Lucene.Net.dll
  Apache Lucene.Net Core library

bin/Demo/*
  Some example applications (Note: These depend on Lucene.Net.dll)

bin/Contrib/*
  Contributed code which extends and enhances Apache Lucene.Net, but is not part of the core library. (Note: These depend on Lucene.Net.dll)

doc/* 
  Visual Studio generated XML doc files for libraries
