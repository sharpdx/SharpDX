...
#define SUBLANG_PULAR_SENEGAL                       0x02    // Pular (Senegal) 0x0867 ff-SN
...

{
    ...
    PreviousFlags = *(volatile SHORT *)Destination;
    do {
        CurrentFlags = PreviousFlags;
    } while ((PreviousFlags = InterlockedCompareExchange16(Destination,
                                                           ExChange,
    ...
    )
{
    ...
    do {
        Old = *Destination;
    } while (InterlockedCompareExchange16(Destination,
                                          Old & Value,
                                          Old) != Old);
...
#define _DataSynchronizationBarrier()        { __emit(0xF3BF); __emit(0x8F4F); }
#define _InstructionSynchronizationBarrier() { __emit(0xF3BF); __emit(0x8F6F); }
...
#define POLICY_AUDIT_SUBCATEGORY_COUNT (57)
...
//
// When the related value (DWORD) is not equal to 0, this setting indicates periods when devices may enter low power states as 
// CS progressed sufficiently far. 
//

// {E1233993-EAA4-470f-9DE7-A351C1B6FB71}
DEFINE_GUID(GUID_LOW_POWER_EPOCH, 0xe1233993, 0xeaa4, 0x470f, 0x9d, 0xe7, 0xa3, 0x51, 0xc1, 0xb6, 0xfb, 0x71);
...
#define IMAGE_REL_ARM_MOV32             0x0010  // ARM: MOVW/MOVT
#define IMAGE_REL_THUMB_MOV32           0x0011  // Thumb2: MOVW/MOVT
#define IMAGE_REL_THUMB_BRANCH20        0x0012  // Thumb2: B
#define IMAGE_REL_THUMB_BRANCH24        0x0014  // Thumb2: B, BL
#define IMAGE_REL_THUMB_BLX23           0x0015  // Thumb2: BLX
