...
__PRIMOP(int, _Is_lock_held_(_In_ __deferTypecheck char *);)
...
__ANNOTATION(SAL_has_lock_property(__AuToQuOtE char *));
__ANNOTATION(SAL_has_lock_level(__AuToQuOtE char *));
...
__ANNOTATION(SAL_set_lock_kind(__AuToQuOtE char *));
__ANNOTATION(SAL_acquires_lock_kind(__deferTypecheck void *,__AuToQuOtE char *));
__ANNOTATION(SAL_releases_lock_kind(__deferTypecheck void *,__AuToQuOtE char *));
__ANNOTATION(SAL_requires_lock_kind_not_held(__deferTypecheck void *,__AuToQuOtE char *));
...
#define _Requires_exclusive_lock_held_(lock) _Pre_ _SA_annotes1(SAL_requires_lock_held,lock)
...
#define _Acquires_lock_kind_(lock, kind) _Post_ _SA_annotes2(SAL_acquires_lock_kind,lock,#kind)
#define _Releases_lock_kind_(lock, kind) _Post_ _SA_annotes2(SAL_releases_lock_kind,lock,#kind)
#define _Requires_lock_kind_not_held_(lock, kind) _Pre_ _SA_annotes2(SAL_requires_lock_kind_not_held,lock,#kind)
...
#define __requires_exclusive_lock_held(lock) __pre _SA_annotes1(SAL_requires_lock_held,lock)
...
#define _Acquires_lock_kind_(lock, kind)
#define _Releases_lock_kind_(lock, kind)
#define _Requires_lock_kind_not_held_(lock, kind)
