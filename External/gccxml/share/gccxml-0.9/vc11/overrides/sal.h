...
// Default for Windows is declspec; original file set this to 0
...
// buffers with explicit element size
...
// Annotations for output params returning pointers
...
// Annotations for output params returning pointers to null terminated strings
...
// Annotations for output params following coding convention where the
...
// Annotations for output params following the COM conventions.
...
// Annotations for output params returning pointer to buffer
...
// Generic annotations to set output value of a by-pointer or by-reference
// parameter to zero on failure.
...
// annotations to express value of integral value parameter
...
#define _Ret_valid_impl_                [returnvalue:__R_impl(__d_=0)]

#define _Check_return_impl_             [returnvalue:__R_impl(__d_=0)]
#define _Must_inspect_impl_             [returnvalue:__R_impl(__d_=0)]
...
#define _Ret1_impl_(p1)                 [returnvalue:__R_impl(__d_=0)]
#define _Ret2_impl_(p1,p2)              [returnvalue:__R_impl(__d_=0)]
#define _Ret3_impl_(p1,p2,p3)           [returnvalue:__R_impl(__d_=0)]
...
#define _Deref_ret1_impl_(p1)           [returnvalue:__R_impl(__d_=0)]
#define _Deref_ret2_impl_(p1,p2)        [returnvalue:__R_impl(__d_=0)]
#define _Deref_ret3_impl_(p1,p2,p3)     [returnvalue:__R_impl(__d_=0)]
...
*/
    ...
    */
    ...
    #define __readonly              _SA_annotes0(SAL_readonly) // _SA_annotes1(SAL_access,0x1)
    #define __notreadonly           _SA_annotes0(SAL_notreadonly) // _SA_annotes1(SAL_access,0x3)
    #define __maybereadonly         _SA_annotes0(SAL_maybereadonly) // _SA_annotes1(SAL_access,0x1)
...
#define __in                                                    _In_
#define __in_ecount(size)                                       _In_reads_(size)
#define __in_bcount(size)                                       _In_reads_bytes_(size)
#define __in_z                                                  _In_z_
#define __in_ecount_z(size)                                     _In_reads_z_(size)
...
#define __out                                                   _Out_
#define __out_ecount(size)                                      _Out_writes_(size)
#define __out_bcount(size)                                      _Out_writes_bytes_(size)
#define __out_ecount_part(size,length)                          _Out_writes_to_(size,length)
#define __out_bcount_part(size,length)                          _Out_writes_bytes_to_(size,length)
#define __out_ecount_full(size)                                 _Out_writes_all_(size)
#define __out_bcount_full(size)                                 _Out_writes_bytes_all_(size)
#define __out_z                                                 __post __valid __refparam __post __nullterminated
#define __out_z_opt                                             __post __valid __refparam __post __nullterminated __pre_except_maybenull
...
#define __out_nz                                                __post __valid __refparam
#define __out_nz_opt                                            __post __valid __refparam __post_except_maybenull_
...
#define __inout_ecount(size)                                    _Inout_updates_(size)
#define __inout_bcount(size)                                    _Inout_updates_bytes_(size)
#define __inout_ecount_part(size,length)                        _Inout_updates_to_(size,length)
#define __inout_bcount_part(size,length)                        _Inout_updates_bytes_to_(size,length)
#define __inout_ecount_full(size)                               _Inout_updates_all_(size)
#define __inout_bcount_full(size)                               _Inout_updates_bytes_all_(size)
#define __inout_z                                               _Inout_z_
#define __inout_ecount_z(size)                                  _Inout_updates_z_(size)
...
#define __ecount_opt(size)                                      __ecount(size)                              __pre_except_maybenull
#define __bcount_opt(size)                                      __bcount(size)                              __pre_except_maybenull
#define __in_opt                                                _In_opt_
#define __in_ecount_opt(size)                                   _In_reads_opt_(size)
#define __in_bcount_opt(size)                                   _In_reads_bytes_opt_(size)
#define __in_z_opt                                              _In_opt_z_
...
#define __out_ecount_opt(size)                                  _Out_writes_opt_(size)
#define __out_bcount_opt(size)                                  _Out_writes_bytes_opt_(size)
#define __out_ecount_part_opt(size,length)                      __out_ecount_part(size,length)              __pre_except_maybenull
#define __out_bcount_part_opt(size,length)                      __out_bcount_part(size,length)              __pre_except_maybenull
#define __out_ecount_full_opt(size)                             __out_ecount_full(size)                     __pre_except_maybenull
#define __out_bcount_full_opt(size)                             __out_bcount_full(size)                     __pre_except_maybenull
...
#define __inout_ecount_opt(size)                                __inout_ecount(size)                        __pre_except_maybenull
#define __inout_bcount_opt(size)                                __inout_bcount(size)                        __pre_except_maybenull
#define __inout_ecount_part_opt(size,length)                    __inout_ecount_part(size,length)            __pre_except_maybenull
#define __inout_bcount_part_opt(size,length)                    __inout_bcount_part(size,length)            __pre_except_maybenull
#define __inout_ecount_full_opt(size)                           __inout_ecount_full(size)                   __pre_except_maybenull
#define __inout_bcount_full_opt(size)                           __inout_bcount_full(size)                   __pre_except_maybenull
...
#define __deref_ecount(size)                                    _Notref_ __ecount(1) __post _Notref_ __elem_readableTo(1) __post _Notref_ __deref _Notref_ __notnull __post __deref __elem_writableTo(size)
#define __deref_bcount(size)                                    _Notref_ __ecount(1) __post _Notref_ __elem_readableTo(1) __post _Notref_ __deref _Notref_ __notnull __post __deref __byte_writableTo(size)
#define __deref_out                                             _Outptr_
#define __deref_out_ecount(size)                                _Outptr_result_buffer_(size)
#define __deref_out_bcount(size)                                _Outptr_result_bytebuffer_(size)
#define __deref_out_ecount_part(size,length)                    _Outptr_result_buffer_to_(size,length)
#define __deref_out_bcount_part(size,length)                    _Outptr_result_bytebuffer_to_(size,length)
...
#define __deref_out_z                                           _Outptr_result_z_
...
#define __deref_inout                                           _Notref_ __notnull _Notref_ __elem_readableTo(1) __pre __deref __valid __post _Notref_ __deref __valid __refparam
#define __deref_inout_z                                         __deref_inout __pre __deref __nullterminated __post _Notref_ __deref __nullterminated
#define __deref_inout_ecount(size)                              __deref_inout __pre __deref __elem_writableTo(size) __post _Notref_ __deref __elem_writableTo(size)
#define __deref_inout_bcount(size)                              __deref_inout __pre __deref __byte_writableTo(size) __post _Notref_ __deref __byte_writableTo(size)
...
#define __deref_ecount_opt(size)                                __deref_ecount(size)                        __post_deref_except_maybenull
#define __deref_bcount_opt(size)                                __deref_bcount(size)                        __post_deref_except_maybenull
//#define __deref_out_opt                                         _Outptr_result_maybenull_
#define __deref_out_opt                                         __deref_out                                 __post_deref_except_maybenull
#define __deref_out_ecount_opt(size)                            __deref_out_ecount(size)                    __post_deref_except_maybenull
#define __deref_out_bcount_opt(size)                            __deref_out_bcount(size)                    __post_deref_except_maybenull
#define __deref_out_ecount_part_opt(size,length)                __deref_out_ecount_part(size,length)        __post_deref_except_maybenull
#define __deref_out_bcount_part_opt(size,length)                __deref_out_bcount_part(size,length)        __post_deref_except_maybenull
#define __deref_out_ecount_full_opt(size)                       __deref_out_ecount_full(size)               __post_deref_except_maybenull
#define __deref_out_bcount_full_opt(size)                       __deref_out_bcount_full(size)               __post_deref_except_maybenull
#define __deref_out_z_opt                                       _Outptr_result_maybenull_z_
...
#define __deref_inout_opt                                       __deref_inout                               __pre_deref_except_maybenull __post_deref_except_maybenull
#define __deref_inout_ecount_opt(size)                          __deref_inout_ecount(size)                  __pre_deref_except_maybenull __post_deref_except_maybenull
#define __deref_inout_bcount_opt(size)                          __deref_inout_bcount(size)                  __pre_deref_except_maybenull __post_deref_except_maybenull
#define __deref_inout_ecount_part_opt(size,length)              __deref_inout_ecount_part(size,length)      __pre_deref_except_maybenull __post_deref_except_maybenull
#define __deref_inout_bcount_part_opt(size,length)              __deref_inout_bcount_part(size,length)      __pre_deref_except_maybenull __post_deref_except_maybenull
#define __deref_inout_ecount_full_opt(size)                     __deref_inout_ecount_full(size)             __pre_deref_except_maybenull __post_deref_except_maybenull
#define __deref_inout_bcount_full_opt(size)                     __deref_inout_bcount_full(size)             __pre_deref_except_maybenull __post_deref_except_maybenull
...
#define __deref_opt_ecount(size)                                __deref_ecount(size)                        __pre_except_maybenull
#define __deref_opt_bcount(size)                                __deref_bcount(size)                        __pre_except_maybenull
#define __deref_opt_out                                         _Outptr_opt_
#define __deref_opt_out_z                                       _Outptr_opt_result_z_
#define __deref_opt_out_ecount(size)                            __deref_out_ecount(size)                    __pre_except_maybenull
#define __deref_opt_out_bcount(size)                            __deref_out_bcount(size)                    __pre_except_maybenull
#define __deref_opt_out_ecount_part(size,length)                __deref_out_ecount_part(size,length)        __pre_except_maybenull
#define __deref_opt_out_bcount_part(size,length)                __deref_out_bcount_part(size,length)        __pre_except_maybenull
#define __deref_opt_out_ecount_full(size)                       __deref_out_ecount_full(size)               __pre_except_maybenull
#define __deref_opt_out_bcount_full(size)                       __deref_out_bcount_full(size)               __pre_except_maybenull
#define __deref_opt_inout                                       _Inout_opt_
#define __deref_opt_inout_ecount(size)                          __deref_inout_ecount(size)                  __pre_except_maybenull
#define __deref_opt_inout_bcount(size)                          __deref_inout_bcount(size)                  __pre_except_maybenull
#define __deref_opt_inout_ecount_part(size,length)              __deref_inout_ecount_part(size,length)      __pre_except_maybenull
#define __deref_opt_inout_bcount_part(size,length)              __deref_inout_bcount_part(size,length)      __pre_except_maybenull
#define __deref_opt_inout_ecount_full(size)                     __deref_inout_ecount_full(size)             __pre_except_maybenull
#define __deref_opt_inout_bcount_full(size)                     __deref_inout_bcount_full(size)             __pre_except_maybenull
...
#define __deref_opt_ecount_opt(size)                            __deref_ecount_opt(size)                    __pre_except_maybenull
#define __deref_opt_bcount_opt(size)                            __deref_bcount_opt(size)                    __pre_except_maybenull
#define __deref_opt_out_opt                                     _Outptr_opt_result_maybenull_
#define __deref_opt_out_ecount_opt(size)                        __deref_out_ecount_opt(size)                __pre_except_maybenull
#define __deref_opt_out_bcount_opt(size)                        __deref_out_bcount_opt(size)                __pre_except_maybenull
#define __deref_opt_out_ecount_part_opt(size,length)            __deref_out_ecount_part_opt(size,length)    __pre_except_maybenull
#define __deref_opt_out_bcount_part_opt(size,length)            __deref_out_bcount_part_opt(size,length)    __pre_except_maybenull
#define __deref_opt_out_ecount_full_opt(size)                   __deref_out_ecount_full_opt(size)           __pre_except_maybenull
#define __deref_opt_out_bcount_full_opt(size)                   __deref_out_bcount_full_opt(size)           __pre_except_maybenull
#define __deref_opt_out_z_opt                                   __post __deref __valid __refparam __pre_except_maybenull __pre_deref_except_maybenull __post_deref_except_maybenull __post __deref __nullterminated
...
#define __deref_opt_inout_opt                                   __deref_inout_opt                           __pre_except_maybenull
#define __deref_opt_inout_ecount_opt(size)                      __deref_inout_ecount_opt(size)              __pre_except_maybenull
#define __deref_opt_inout_bcount_opt(size)                      __deref_inout_bcount_opt(size)              __pre_except_maybenull
#define __deref_opt_inout_ecount_part_opt(size,length)          __deref_inout_ecount_part_opt(size,length)  __pre_except_maybenull
#define __deref_opt_inout_bcount_part_opt(size,length)          __deref_inout_bcount_part_opt(size,length)  __pre_except_maybenull
#define __deref_opt_inout_ecount_full_opt(size)                 __deref_inout_ecount_full_opt(size)         __pre_except_maybenull
#define __deref_opt_inout_bcount_full_opt(size)                 __deref_inout_bcount_full_opt(size)         __pre_except_maybenull
