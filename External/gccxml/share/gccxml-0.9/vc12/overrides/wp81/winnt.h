...
//
// Specifies if a system with a PEP is entering or exiting a low-power mode
...
typedef struct _IMAGE_LOAD_CONFIG_DIRECTORY64 {
    ...
    ULONGLONG  GuardCFBitMapAddress;        // VA
